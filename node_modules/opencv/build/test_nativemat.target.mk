...
CFLAGS_Debug := \
	...
	-m64 \
	-I/home/ec2-user/aws-lambda-opencv/build/opencv/include/opencv \
	-I/home/ec2-user/aws-lambda-opencv/build/opencv/include \
	-Wall \
	-g \
	-O0
...
INCS_Debug := \
	...
	-I$(srcdir)/-I/home/ec2-user/aws-lambda-opencv/build/opencv/include/opencv \
	-I$(srcdir)/-I/home/ec2-user/aws-lambda-opencv/build/opencv/include \
	-I$(srcdir)/../nan \
	-I$(srcdir)/inc
...
LIBS := \
	-L/home/ec2-user/aws-lambda-opencv/build/opencv/lib \
	-L/home/ec2-user/aws-lambda-opencv/build/opencv/share/OpenCV/3rdparty/lib \
	-lopencv_contrib \
	-lopencv_stitching \
	-lopencv_nonfree \
	-lopencv_superres \
